<%@ page import="mcs.Utils; app.Indicator" %>
...
<div class="kanban">
<table  border="1" style="width: 98% !important ; max-width: 98% !important; border: #496779; border-collapse: collapse;">
...
<g:if  test="${mcs.Course.executeQuery('select count(*) from Course c where c.bookmarked = 1')[0] == 0}">
    ...
    <tr>
        ...
        <g:each in="${mcs.Course.executeQuery('from Course c where c.bookmarked = 1 order by c.department.code', [])}"
                var="d">
      <td style="">
